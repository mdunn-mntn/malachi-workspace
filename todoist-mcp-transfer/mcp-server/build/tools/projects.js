...
export function registerProjectTools(server, api) {
    server.tool("todoist_list_projects", "List all projects in Todoist.", {}, async () => {
        try {
    ...
    server.tool("todoist_get_project", "Get details of a specific project.", {
    ...
    server.tool("todoist_create_project", "Create a new project.", {
    ...
    server.tool("todoist_delete_project", "Permanently delete a project and all its tasks. This cannot be undone.", {
