...
- **HexClad — real decline, and it's a gate problem.** Its prospecting kept leaving High-Intent because the intent gate was **thrashed** — removed to **0 (serve anyone)** mid-November for the holiday (HI-share crashed from ~97% to ~11–15%), briefly restored to 10,000 in January (HI recovered to ~80%), off again in February, oscillating since. So the campaign spends **repeated, extended stretches ungated** — worst during the Nov–Dec holiday blowout when spend/volume also exploded. Delivery HI-share tracks the gate every time. Conversions halved, AOV flat. **Fix: restore & *hold* the gate (stop the thrashing), run flights ≥4 days, pace ~$5K/day.**
...
- **Why did it stop targeting HI only?** Two things:
  ...
  2. **Short flights + constant re-adjustment.** HexClad adds budget in **1–2 day flights**; **any flight under 72 hours automatically sets HHST to 0** (a deliverability safeguard). Combined with manual holiday changes and the Fangorn-era continuous ramps, the gate is **thrashed — 66 changes on the flagship over the year**: removed mid-Nov, restored to 10,000 Jan 5, off again Feb 5, then oscillating 0↔6666 through the spring. It is **not** "set to 0 permanently" — but it is **never durably held at High-Intent**, so delivery repeatedly falls out of HI. A second "General Interest" campaign runs alongside at **100% unscored by design.**
