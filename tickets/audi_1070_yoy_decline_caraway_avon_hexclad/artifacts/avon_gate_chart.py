...
ax.annotate("Jan 6: RE-GATED\nto 10,000\n(HexClad never did)",xy=(7,79),xytext=(5.9,33),fontsize=8.5,color=GREEN,ha="center",fontweight="bold",arrowprops=dict(arrowstyle="->",color=GREEN,lw=1.3))
