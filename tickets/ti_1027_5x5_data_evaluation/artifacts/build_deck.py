...
<section>
  ...
  <p class="byline">Malachi Dunn · Audience Intelligence (AUDI) · TI-1027</p>
</section>
...
<section>
  ...
  <p class="byline">TI-1027 · Audience Intelligence (AUDI)</p>
</section>

<section>
  <h2>Appendix — how the pay numbers are derived</h2>
  <ul>
    <li><b>Two inputs:</b> market rate <b>$0.50 / 1,000 impressions</b> (peer rate; our logs show ~$0.001/impr data cost ≈ $1 CPM) · 5x5 touches <b>34.35M impr/day</b> (12.5B/yr), of which <b>213.5K/day</b> go to households only it saw.</li>
    <li><b>Ceiling ~$525K/mo:</b> 34.35M × $0.50 ÷ 1,000 × 365 = $6.3M/yr — peer rate on ALL touched impressions. Hard upper bound (74% of its IPs we already see, so most of that traffic happens anyway).</li>
    <li><b>Floor ~$3K/mo:</b> 213.5K × $0.50 ÷ 1,000 × 365 = $40K/yr — only impressions to households 5x5 uniquely brought.</li>
    <li><b>Fair $15–50K/mo:</b> between the bounds — ~12% of MM's usable domain signal × MM's $210–385M/yr touched media, cross-checked vs typical DDP flat fees (5x5 = #2 most-unique → upper end).</li>
    <li><b>Volume mins:</b> ≥2.5B rows/mo (lock delivery; current ~2.8B) + ≥25M unique IP×domain pairs/day (anti-padding — 93M daily events collapse to ~33M distinct).</li>
    <li><b>CPM caveat:</b> $0.50 only on MATCHED impressions; on ALL touched it's $0.02–0.05 (= the fair monthly) — $0.50 on all-touched = the $6.3M trap.</li>
  </ul>
