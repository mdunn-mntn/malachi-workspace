...
- **RFD drafted 2026-07-28** → `artifacts/audi_1175_rfd_draft.md` (decision doc / Request-for-Decision, Confluence-ready; mirrors the AUDI-1173 freq-cap RFD). Socialize with the `audience_intent` owner (likely Ryan Kleck / AUDI team) + heads-up DDM/Devon before beginning AUDI-1176. The ask: approve the work, name a co-owner, agree the shadow-run delivery-parity gate.
