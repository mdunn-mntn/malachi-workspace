---
doc_type: ticket
title: "Optimize Airflow/Spark jobs from log + perf analysis"
status: backlog
date: 2026-07-31
summary: "Task: mine job logs (airflow_pull.sh, bq_perf_log, Dataproc batch analysis) for slow/costly stages and apply optimizations (speed + cost)."
result: "not started"
question: ""
framing_state: draft
---

# Optimize Airflow/Spark jobs from log + perf analysis
