...
#lagged_date = "2026-02-21"
reference_date = "2026-03-16"
lagged_date = "2026-03-15"

bucket_name = "targeting-infra-vertex-pipelines-prod"

pred_path = f"gs://{bucket_name}/bottom-up-keywords/batch-predictions/dt={reference_date}/"

#pred_path = f"gs://{bucket_name}/bottom-up-keywords/pipeline-root/401977096985/batch-prediction-pipeline-20260223023807/generate-predictions_4077735701368537088/predictions"
...
(ip_adv_scores
 ...
 .parquet("gs://mntn-data-archive-dev/alex.knorr/test_keyword_ip_scoring"))
