# Kindred Bravely (35094) — prospecting diagnosis (TL;DR)

**Verdict: REAL DECLINE.** 6 red flag(s), 3 amber. Comparison: Jan–May '25 (pre) vs Jan–May '26 (post).
...
- **Prospecting campaigns** — 1 → 6: went 1 -> 6 campaigns (more campaigns compete for the same bids)
- **3P restriction** —  → 6/6 use 3P: 3P added as OR (additive, not restrictive)
...
| Geo restriction | — | 6/6 DMA-limited | 🔴 prospecting is geo-restricted (removing geo limits widens the pool) |
| 3P restriction | — | 6/6 use 3P | 🟠 3P added as OR (additive, not restrictive) |
| HI-share of reached | no data | 90% | 🟢 P1 predates score logging |
