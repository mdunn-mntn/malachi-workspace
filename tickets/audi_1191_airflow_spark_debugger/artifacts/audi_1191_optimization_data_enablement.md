...
— see `../../audi_1194_optimizer_efficiency_crawler/artifacts/audi_1194_spark_data_inventory.md`. Prefer it over `explain()`-to-stdout, which gets only the plan. Databricks is best enforced via the existing **cluster policy**
