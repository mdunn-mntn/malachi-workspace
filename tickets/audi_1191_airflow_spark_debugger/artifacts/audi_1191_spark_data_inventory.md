...
| 5 | Storage | `/storage/rdd`, `/storage/rdd/{id}` | (RDD block updates) | cached memoryUsed/diskUsed, fraction cached, partitions | cache effectiveness — is the cache used or evicted (INC-005 uncached recompute) |
