# Optimizer coverage — 2026-08-20

62 active DAGs. 24 have a Spark task; 38 do not and are invisible to this tool.
...
- `intent_score_household_map` (intent_score_household_map)
