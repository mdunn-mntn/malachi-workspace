# Optimizer coverage — 2026-08-21

63 active DAGs. 25 have a Spark task; 38 do not and are invisible to this tool.

- profiled this sweep: 2
- Spark DAGs with no log this sweep: 23
- no Spark task at all: 38
...
- `materialize_mntn_select` (materialize)
