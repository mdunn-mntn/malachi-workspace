...
<section>
  ...
  <h2>Two simple questions per vendor</h2>
  <ul>
    <li><span class="navy">Did it pay for itself?</span> Money made = the impressions only this vendor could serve × our measured media rate × margin. Below the bill = overpaying.</li>
    <li><span class="navy">What do we already have for free?</span> Every vendor is measured against our two internal free logs (guid, augmentor) — the \\$0 baseline we keep either way.</li>
    <li>All 10 sources (8 paid + 2 free) are measured the same way, against the <span class="navy">billed</span> impressions — not raw rows delivered.</li>
  </ul>
</section>
...
<section>
  ...
  <table>
    <tr><th>Vendor</th><th class="n">Bill after preempt</th><th class="n">Money-made value</th><th class="n">Worth ÷ bill</th></tr>
    <tr><td>33Across API</td><td class="n">\\$142.8K</td><td class="n">\\$45–134K</td><td class="n">0.32–0.94×</td></tr>
    <tr><td>33Across</td><td class="n">\\$259.9K</td><td class="n">\\$72–217K</td><td class="n">0.28–0.83×</td></tr>
    <tr><td>Sovrn</td><td class="n">\\$115.8K</td><td class="n">\\$11–34K</td><td class="n red">0.09–0.29×</td></tr>
    <tr><td>Cybba</td><td class="n">\\$17.7K</td><td class="n">\\$1–3K</td><td class="n red">0.06–0.17×</td></tr>
    <tr><td>Justuno</td><td class="n">\\$75.8K</td><td class="n">\\$4–11K</td><td class="n red">0.05–0.15×</td></tr>
  </table>
  <p class="sub">Worth = <span class="navy">money-made</span> = unique won impressions × measured media eCPM (exact) × margin band, ×52. Range = the margin band. All &lt; 1.0× even at the top margin — none paid for itself.</p>
</section>

<section>
  <div class="kicker">What we should pay</div>
  <h2>Two moves, in order</h2>
  <p class="lead"><span class="navy">1. Preempt</span> — stop billing signal a free log already had: <span class="navy">−~\\$200K/yr</span>, keep all data, needs no vendor.
     &nbsp;&nbsp;<span class="navy">2. Renegotiate down or drop</span> the residual:</p>
  <table>
    <tr><th>Vendor</th><th class="n">Current</th><th class="n">After preempt</th><th>Recommendation</th></tr>
    <tr><td>33Across (DS28)</td><td class="n">\\$422.0K</td><td class="n">\\$259.9K</td><td>Renegotiate down — biggest lever</td></tr>
    <tr><td>33Across API (DS40)</td><td class="n">\\$175.9K</td><td class="n">\\$142.8K</td><td>Renegotiate down or drop (same vendor as DS28)</td></tr>
    <tr><td>Sovrn (DS33)</td><td class="n">\\$115.9K</td><td class="n">\\$115.8K</td><td class="red">Drop</td></tr>
    <tr><td>Cybba (DS36)</td><td class="n">\\$21.5K</td><td class="n">\\$17.7K</td><td class="red">Drop</td></tr>
    <tr><td>Justuno (DS24)</td><td class="n">\\$77.1K</td><td class="n">\\$75.8K</td><td>Renegotiate down or drop</td></tr>
    <tr><td>Klickly / Predactiv / 5x5</td><td class="n">flat</td><td class="n">—</td><td>Klickly drop · Predactiv &amp; 5x5 keep</td></tr>
  </table>
  <p class="sub">The \\$0.50 rate isn't the problem — the volume is. Sequence: lock flats → preempt → renegotiate 33Across → drop the rest.</p>
</section>
