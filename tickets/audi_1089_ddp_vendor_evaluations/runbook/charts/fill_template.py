...
CONVENTIONS = [
    ...
    "Exact drop savings = annual bill x share of credits NOT reassigning to another metered vendor (q3b, FIRST-REPORTER model). CAVEAT 2026-07-13: billing credit is likely a FRACTIONAL SPLIT across contributing vendors (decimal billed imps; audits table platform-total; team testimony) - under that model shared-credit fractions redistribute and savings shift toward the sole-credit share. Verify via targeted_signal before executing drops. Flat vendors: savings = the flat fee itself either way.",
