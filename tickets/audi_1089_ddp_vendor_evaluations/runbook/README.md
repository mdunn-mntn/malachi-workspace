...
`outputs/audi_1089_quality_template_filled.xlsx` answers every row of the user's question
template (106 rows x 14 vendor columns). It is regenerated by `charts/fill_template.py`
(idempotent — rerun after any scan lands). Sources, in query order:
