...
- DS39 payload is thinnest possible: IP + URL + timestamp only; 93.4% *.myshopify.com product pages; delivery is vendor-side streaming, so the off-switch is vendor-side not a DAG change.
