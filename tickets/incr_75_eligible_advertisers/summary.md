...
**The well-powered answer to the hypothesis (Kirsa: "does excluding high intent improve incrementality?"):** the platform-wide persuadables gradient — High +0.2% (dead) / PP +1.6% / Mid +3.3% / MaxReach +3.4% / no_score +0.1% (dead). Yes, blocking high intent should improve incrementality — IFF freed spend flows to mid-intent (untargeted reach is incrementally dead too). This one campaign is directionally consistent but can't prove it. Added as a "Platform evidence" sheet.
