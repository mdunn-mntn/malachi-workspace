...
**Result (626276, entry-cohort, exclude 06-22, window 06-23..07-14):** treatment 242,795 IPs / VR 0.104%; holdout 26,367 IPs / VR 0.080% (ghost_frac 0.098, clean). **Relative visit lift +30.3% (abs +0.024pp), z=1.30, p=0.19, 95% CI [−15%, +76%]** — directionally positive, underpowered (only 21 holdout visits, treatment win rate 37%). Conversions too sparse to measure (treat 3 / hold 1). On-thesis: excluding high intent trades raw visit rate for incremental value.
...
**Deliverable:** `outputs/incr_75_gruns_cgid126905_incrementality.xlsx` (+ Drive `My Drive/Tickets/INCR-75/INCR-75 Gruns Incrementality CGID 126905.xlsx`). Builder `artifacts/incr_75_gruns_cgid126905_xlsx.py`; CSVs `outputs/incr_75_gruns_cgid126905_{lift,performance}.csv`. 5 sheets: Overview, Incremental lift, Performance, Read me (plain-English caveats), Queries. Note: `group_id` in `cost_impression_log`/`ui_conversions` = `campaign_group_id`.
