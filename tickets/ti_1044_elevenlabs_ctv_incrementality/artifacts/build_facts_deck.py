...
<section style="text-align:left;">
  ...
  <ul style="font-size:0.44em;line-height:1.55;">
    ...
    <li>guid = total visits to ElevenLabs' site only (advertiser_id 51660). Their site is huge — 5.4M visitor IPs / 10d.</li>
    <li style="color:{RED};"><b>Cross-device undercount:</b> we match CTV-impression IP (TV/home router) to web-visit IP (phone/laptop). Cross-device / cellular visits have a different IP → missed. This can bias our visit lift <b>downward</b>. The geo test (device-agnostic) is cleaner here and also ≈0. Fix: household-graph matching.</li>
  </ul>
</section>
