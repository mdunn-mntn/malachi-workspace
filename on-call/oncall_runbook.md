...
- **Related thread:** the `batch_fetch` failures "the last couple of days" (INC-006) are fixed by **shopper_graph#296**, which Malachi merged but hadn't deployed — the meeting also covered **redeploying shopper_graph** to ship it.
