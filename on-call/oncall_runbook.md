...
1. **`default_args={}` means `retries` is 0** on a severity-1 hourly job. A 16-second transient pages a human for something a single retry would have swallowed. Logged IMP-044.
