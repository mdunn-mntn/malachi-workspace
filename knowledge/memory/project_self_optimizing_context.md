...
See [[reference-ticket-context-eval-tooling]] for how to run/extend, and [[feedback-adversarial-workflow-authoring]] for the calibration lessons. Related: [[project-structured-bq-catalog]], [[project-super-structure-adoption]].
