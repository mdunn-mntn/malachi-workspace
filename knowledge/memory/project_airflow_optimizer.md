...
repo facts: [[reference_airflow_ti]].
...
575.6 exec-h/day = $160.02/day, est $58.4k/yr at $0.278/exec-h.** Ledger: 446 rows with `exec_h`,
266 findings-only.
...
**BQ surface is blocked until both merge.** Separately, `fangorn_score_monitor` #1231 was
re-marked applied 2026-08-27, so measured savings restarted from 0 and rebuild daily.
