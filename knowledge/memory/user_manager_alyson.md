---
name: user_manager_alyson
description: Malachi's manager is Alyson Lefkowitz; Mike Dolt was only fill-in manager while she was out
metadata:
  node_type: memory
  type: user
doc_type: memory
keywords: [manager, boss, Alyson Lefkowitz, Mike Dolt, fill-in, reporting line, org]
domain: [routing-people, leadership]
lifecycle: active
