...
- **REMOVE-DS14 EXPERIMENT: PREMISE BROKEN 2026-08-25.** Kirsa herself has no idea what this experiment is ("I am very lost... not clear on what experiment this is referring to"), Sean Yang didn't know its status and thought all experiments were held for MNTN-ID work, and the 2026-07-30 capture that recorded it carries NO provenance (no transcript, Slack quote, or named informant anywhere in git). Treat the claim below as UNVERIFIED second-hand; the AUDI-1176 hold built on it is likely void. Settling check: ask Sean/Zach/Ryan (the recorded sign-off owners) whether ANY remove-DS14 experiment exists anywhere; if nobody claims it, unpark AUDI-1176.
