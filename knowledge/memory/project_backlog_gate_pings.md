...
- AUDI-1016 → Eric Salinger: RESOLVED 2026-08-25, ticket VALIDATED not closed. Already on ScyllaDB; Eric sizes ~92% of segment writes as empty, conditional write ~400k→40k tps (10x). Posted to the ticket. Next: agree implementation with Eric's team (they own the membership consumer); the sizing half of the reframe is done.
