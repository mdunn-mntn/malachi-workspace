...
- AUDI-1176 → Sean Yang: REPLIED 2026-08-24, status unknown to Sean; he thinks all experiments are held off for the MNTN-ID work and will raise it in the Kirsa meeting 2026-08-25. RESOLVED 2026-08-25: hold VOID, provenance found (Kirsa's floated-and-downgraded idea, never a plan; she doesn't recognize it). 1176 unparked, sprint-ready; next = §3 shadow run ([[project_incrementality_experiment]]).
