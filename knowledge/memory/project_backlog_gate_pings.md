...
- AUDI-1176 → Sean Yang: REPLIED 2026-08-24, status unknown to Sean; he thinks all experiments are held off for the MNTN-ID work and will raise it in the Kirsa meeting 2026-08-25. 2026-08-25: Kirsa DOES NOT RECOGNIZE the experiment; the 7/30 claim has no recorded provenance. Premise likely void; confirm at the 2:30 meeting that nobody claims a remove-DS14 experiment, then unpark 1176 ([[project_incrementality_experiment]]).
...
- AUDI-1016 → Eric Salinger: RESOLVED 2026-08-25, ticket VALIDATED not closed. Already on ScyllaDB; Eric sizes ~92% of segment writes as empty, conditional write ~400k→40k tps (10x). Direction agreed: NO Scylla-side conditional write (~$20k/mo cache, rejected); fix is upstream. Meeting 03 (Eric+Matt, same day) answered all six clarifying questions; Eric's ranking pure-Kafka > deltas > suppress-empties. **Converted to [SPIKE] in Jira (issuetype 11467) and added to active sprint 8303 (08/24-09/07); spike = feasibility of Kafka streaming vs deltas.** Full record: ti_1016 summary.md §4.4-§5b. This closes the last of the 7 gate pings for meetings; AUDI-1176 and AUDI-1145 still await external answers.
