...
metadata:
  ...
  type: reference
doc_type: memory
keywords: [holdout lift, lift__holdout, lift__ghost_bid_rollup, v_lift__results_by_month, lift__conversions, incrementality dashboard, holdout-based lift, observational lift, Matt Brorby, Nick Martin, reporting dataset, enriched dataset, is there a newer incrementality table]
