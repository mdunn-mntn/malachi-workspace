...
- **Databricks** — `~/.databrickscfg` currently holds BOTH an OAuth profile (`malachi@mountain.com`) and a **long-lived PAT under `[DEFAULT]`**. The PAT is exactly the pattern MNTN decommissioned with the Slack bot on 2026-06-10 and should be removed as part of this work.
