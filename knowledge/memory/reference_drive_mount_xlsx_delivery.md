...
doc_type: memory
keywords: [drive organization, drive folder naming, my drive structure, drive mv trash footgun, drive mount, xlsx delivery, google drive local mount, My Drive Tickets, openpyxl formatting, gsheet pointer, overwrite live file, column widths, AUDI-1141]
domain: [workflow]
lifecycle: active
...
was expired and authed to the wrong (personal) account. [[reference_mntn_google_drive_access]]
