...
- **Clear tasks:** `POST /dags/<dag>/clearTaskInstances` body
  `{"dag_run_id": ..., "task_ids": [...], "include_downstream": true, "only_failed": false}`.
- **`run_id` in URL PATHS must be URL-encoded** (`+` -> `%2B`) or the API 404s.
