...
**Why:** "Bottoms-Up Keywords" was engineering-flavored (describes the methodology, not the value) and didn't translate in exec or buyer conversations. "Behavior Keywords" keeps the word "keywords" — which paid-search buyers already trust — and pivots the source ("from behavior, not from the query typed").
