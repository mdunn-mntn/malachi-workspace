---
doc_type: bq_table
title: aggregates._bqc_c40f0fe47b9442dcacc7304bfbe3d6bf
summary: "one row per <FILL grain> — <what it's for>"
dataset: aggregates
table: _bqc_c40f0fe47b9442dcacc7304bfbe3d6bf
...
time_unit: unknown
ttl_days: null
approx_rows: 906959153
approx_logical_bytes: 48975794262
...
# aggregates._bqc_c40f0fe47b9442dcacc7304bfbe3d6bf
...
## Example queries
```sql
SELECT <cols> FROM `aggregates._bqc_c40f0fe47b9442dcacc7304bfbe3d6bf` WHERE <partition_col> BETWEEN '<start>' AND '<end>'
```
