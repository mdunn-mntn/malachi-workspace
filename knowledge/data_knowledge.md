...
**AUDI-1208 sizing baseline (2026-08-17) — the numbers to start from when someone asks "how big is X".** Verticals (148): mean 9,479,187 distinct IPs, median 6,557,786, Q1 3,959,353, Q3 12,026,014, min 919,345 (`101005`), max 76,274,119 (`124000 Current Affairs`). Buckets (37): mean 25,952,755, median 20,852,312, Q1 11,362,823, Q3 33,340,029. HI pool per MM prospecting audience (funnel 1, n=2,063): mean 4,772,375, median 3,553,726, Q1 1,644,679, Q3 5,958,157, max 41,760,550; same audiences at ANY score: mean 51,321,823 / median 43,120,471. **Both distributions are strongly right-skewed (mean ≈ 1.4x median for verticals, 1.34x for HI pools) — quote quartiles, not the mean alone.** Verticals overlap by design: an IP averages ~6.6 verticals, so the 148 sizes sum to ~1.40B against a 214,079,274-IP base — **never add category sizes.** Full record: `tickets/audi_1208_vertical_hi_audience_sizing/summary.md`.
