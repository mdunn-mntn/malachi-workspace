...
- **Non-Fangorn = BUCKETED (discrete):** High = **exactly 10000**, Peak = **exactly 8000**, Mid = 3333–6665 (engagement continuous), Max Reach = 1–3332. Platform supply (May 2026): HI 14.0B IPs vs **PP 33.0B IPs — PP is 2.4× larger** (HI=vertical∩keyword is scarce; PP=vertical-only is abundant → scaling spend past the HI pool floods into PP).
